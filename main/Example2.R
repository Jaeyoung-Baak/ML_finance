...
attach(Carseats)
# Carseats dataset의 변수들을 사용 
head(Carseats)

########################
# Classification Trees 생략  #
########################
...
# High를 종속변수로, X는 High와 Sales를 제외한 나머지 변수들 
...
# Bagging (m = p), mtry: split에 사용하는 변수의 수, 이 경우는 모든 설명 변수 사용 
...
# Random Forests (m < p), mtry: split에 사용하는 변수의 수, 이 경우는 설명 변수 4개만 사용 
